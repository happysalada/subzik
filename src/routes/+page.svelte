    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          Support the artists you love and get exclusive content
        </h1>
        <p class="mt-6 text-lg leading-8 text-gray-600">
          The preferred way to interact with your beloved artists.
        </p>
    ...
    <div class="relative bg-gray-800 pb-32">
      ...
      <div class="relative mx-auto max-w-7xl py-24 px-6 sm:py-32 lg:px-8">
        ...
        <p class="mt-6 max-w-3xl text-xl text-gray-300">
          and get the following exclusives
        </p>
      </div>
    </div>
      ...
      >
        <div class="flex flex-col rounded-2xl bg-white shadow-xl">
          <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
            ...
            <h3 class="text-xl font-medium text-gray-900">Music</h3>
          ...
          <div class="rounded-bl-2xl rounded-br-2xl bg-gray-50 p-6 md:px-8">
            <a
              ...
              >Check out artists<span aria-hidden="true"> &rarr;</span></a
            >
          </div>
        </div>
        ...
        <div class="flex flex-col rounded-2xl bg-white shadow-xl">
          <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
            ...
            <h3 class="text-xl font-medium text-gray-900">Tickets</h3>
            <p class="mt-4 text-base text-gray-500">
              Get exclusive backstage passes, and special tickets.
            </p>
          </div>
          <div class="rounded-bl-2xl rounded-br-2xl bg-gray-50 p-6 md:px-8">
            <a
              href="#"
              class="text-base font-medium text-indigo-700 hover:text-indigo-600"
              >Check artists<span aria-hidden="true"> &rarr;</span></a
            >
          </div>
        </div>
        ...
        <div class="flex flex-col rounded-2xl bg-white shadow-xl">
          <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
            ...
            <h3 class="text-xl font-medium text-gray-900">NFTs</h3>
            <p class="mt-4 text-base text-gray-500">
              Get to own a portion of the mucic rights and make money!
            </p>
          </div>
          <div class="rounded-bl-2xl rounded-br-2xl bg-gray-50 p-6 md:px-8">
            <a
              href="#"
              class="text-base font-medium text-indigo-700 hover:text-indigo-600"
              >View NFTs for sale<span aria-hidden="true"> &rarr;</span></a
            >
          </div>
        </div>
      </div>
